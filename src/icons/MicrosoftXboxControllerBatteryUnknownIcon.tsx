...
export const MicrosoftXboxControllerBatteryUnknownIcon: FC<IMicrosoftXboxControllerBatteryUnknownIconProps> =
  memo(props => <MicrosoftXboxControllerBatteryUnknownSvg {...props} />);
