...
export const MicrosoftXboxControllerBatteryChargingIcon: FC<IMicrosoftXboxControllerBatteryChargingIconProps> =
  memo(props => <MicrosoftXboxControllerBatteryChargingSvg {...props} />);
