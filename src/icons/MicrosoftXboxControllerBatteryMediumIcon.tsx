...
export const MicrosoftXboxControllerBatteryMediumIcon: FC<IMicrosoftXboxControllerBatteryMediumIconProps> =
  memo(props => <MicrosoftXboxControllerBatteryMediumSvg {...props} />);
