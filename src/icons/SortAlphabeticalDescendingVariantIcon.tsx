...
export const SortAlphabeticalDescendingVariantIcon: FC<ISortAlphabeticalDescendingVariantIconProps> =
  memo(props => <SortAlphabeticalDescendingVariantSvg {...props} />);
