...
export const MicrosoftXboxControllerBatteryFullIcon: FC<IMicrosoftXboxControllerBatteryFullIconProps> =
  memo(props => <MicrosoftXboxControllerBatteryFullSvg {...props} />);
