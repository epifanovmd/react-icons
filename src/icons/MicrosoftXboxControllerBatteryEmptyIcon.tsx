...
export const MicrosoftXboxControllerBatteryEmptyIcon: FC<IMicrosoftXboxControllerBatteryEmptyIconProps> =
  memo(props => <MicrosoftXboxControllerBatteryEmptySvg {...props} />);
