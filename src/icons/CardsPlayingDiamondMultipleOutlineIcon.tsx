...
export const CardsPlayingDiamondMultipleOutlineIcon: FC<ICardsPlayingDiamondMultipleOutlineIconProps> =
  memo(props => <CardsPlayingDiamondMultipleOutlineSvg {...props} />);
